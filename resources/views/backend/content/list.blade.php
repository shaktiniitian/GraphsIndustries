        ...
        <div class="ibox">
            <div class="ibox-body">
                <div class="flexbox mb-4m">
                    ...
                    <h5 class="font-strong mb-4">Content LIST</h5>

                        <a class="btn btn-rounded btn-pink btn-air right" href="{{route('content.create')}}">Add New</a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover" id="products-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{ !empty($data->category->title) ? ucfirst($data->category->title) : '' }}</td>
                                <td>
                                    <span
                                ...
                                <td width="100">
                                    ...
                                    <form action="{{ url('admin/content' , $data->id ) }}" method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
