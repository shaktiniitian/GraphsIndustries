...
@section('content')
@php
$action = !empty($item) ? route('products.update', $item->id) : route('products.store');
@endphp
    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-md-10">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title"><span class="text-info">{{ Session::get('pageTitle') }}</span> ADD NEW
                        </div>
                    ...
                    <div class="ibox-body">
                        ...
                        <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="summernote" rows="4" name="description"
                                    placeholder="Enter Description">{{ !empty($item) ? $item->description : old('description') }}</textarea>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group-inner">
                                    <img src="{{asset('normal_images/products/'.$item->file )}}" width="100"
                                        height="100">
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="form-group mb-4">
                                <label class="ui-switch switch-icon switch-solid-success mr-3 mb-0">
                                    <input type="checkbox" name="status" value="1" {{ !empty($item) ? ($item->status==1
                                    ? 'checked' : '') : 'checked' }}>
                                    <span></span>
                                </label>Status
                            </div>
