            ...
            <div class="ibox-body">
                <div class="flexbox mb-4m">
                    ...
                    <div class="flexbox  col-md-12">
                        ...
                        <a class="btn btn-rounded btn-pink btn-air right" href="{{route('project-gallery.create')}}">Add New</a>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="100">
                                    ...
                                    <a href="{{ route('project-gallery.edit', $data->id) }}">
                                        <button data-toggle="tooltip" title="Edit"
                                            class="pull-left btn-sm btn btn-info"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i></button>
                                    </a>

                                    <form action="{{ url('admin/project-gallery' , $data->id ) }}" method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
