...
@section('content')
@php
$action = !empty($item) ? route('videos.update', $item->id) : route('videos.store');
@endphp
                    ...
                    <div class="ibox-body">
                        ...
                        <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="url" value="{{ !empty($item) ? $item->url : old('url') }}" id="url" name="url" class="form-control col-md-7 col-xs-12">
